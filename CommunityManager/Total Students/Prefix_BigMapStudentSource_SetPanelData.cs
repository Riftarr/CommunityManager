...
{
    [HarmonyPatch(typeof(BigMapStudentSource), nameof(BigMapStudentSource.SetPanelData))]
    internal static class Prefix_BigMapStudentSource_SetPanelData
    {
        public static void Prefix(BigMapStudentSource __instance)
        {
            try
            {
